...
<div class="container mt-5" style="margin-top: 50px;">
    <div class="row justify-content-center text-center">
        <div class="col-md-4">
            <div class="card" onclick="location.href='./orders/orders_show.php';">
                <a href="./orders/orders_show.php" class="btn btn-primary btn-block">
        ...
        <div class="col-md-4">
            <div class="card" onclick="location.href='./orders/orders_add.php';">
                <a href="./orders/orders_add.php" class="btn btn-primary btn-block">
                    <img src="../img/add1.png" alt="Car Icon">
