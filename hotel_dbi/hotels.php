...
<style>
  ...
  <div class="container mt-5" style="margin-top: 50px;">
    <div class="row justify-content-center text-center">
        <div class="col-md-4">
            <div class="card" onclick="location.href='./hotels/hotels_show.php';">
                <a href="./hotels/hotels_show.php" class="btn btn-primary btn-block">
                    <img src="../img/show.png" alt="Hotels Icon">
        ...
        <div class="col-md-4">
            <div class="card" onclick="location.href='./hotels/hotels_add.php';">
                <a href="./hotels/hotels_add.php" class="btn btn-primary btn-block">
                    <img src="../img/add1.png" alt="Hotels Icon">
